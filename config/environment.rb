...
Rails::Initializer.run do |config|
  ...
  config.action_controller.session = { :session_key => "_admiteer_session", :secret => "admiteer_secret" }
end
...
Geocode.geocoder = Graticule.service(:yahoo).new 'secret'
GOOGLE_APPLICATION_ID = RAILS_ENV.eql?('production') ?
                          'secret' :
                          'secret'

Mime::Type.register "text/html;charset=utf-8", :map
